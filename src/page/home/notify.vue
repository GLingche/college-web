<template>
    <div class="notify h-full">
            ...
            <div class="msg-content" v-if="msgType == 'approval'">
                ...
                >
                    ...
                    <span class="msg-item-btn">
                        <el-button
                            type="text"
                            @click="onApproval(item.id, true, false)"
                            >同意</el-button
                        >
                        <el-button
                            type="text"
                            @click="onApproval(item.id, false, false)"
                            >拒绝</el-button
                        >
                    </span>
                </div>
        ...
        <!-- 消息细节 -->
        <el-dialog :visible.sync="detialDialog" title="查看消息" @close="dialogClose">
            <div class="detial-container">
                <div class="detial-title">{{ detialData.title }}</div>
                <div class="detial-time">
                    平台运营组发布于{{ detialData.sendTime }}
                </div>
