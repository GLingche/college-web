<template>
    <div class="profile">
        <div class="header">
            ...
            <span class="content" v-if="identity == 'person'">个人账号信息</span>
            <span class="content" v-else>个人账号信息</span>
        </div>
        <el-card class="profile-card">
            <div slot="header" v-if="identity == 'person'">个人账号信息</div>
            <div slot="header" v-else>个人账号信息</div>
            <div class="title">
                <span>基本信息</span>
            </div>
            <div class="base-info">
                <div class="base-info-item">
                    <div class="flex">
                        ...
                        <auto-avatar style="width: 36px; height: 36px" :src="accountInfo.avatarPath"
                            :name="accountInfo.realname"></auto-avatar>
                    </div>
                    <el-button type="text" @click="openUploadDialog">修改</el-button>
                </div>
                <div class="base-info-item">
                    <div class="flex">
                    ...
                    <el-button type="text" @click="openModifyDialog('修改姓名', 'name')">修改</el-button>
                </div>
                <div class="base-info-item">
                    <div class="flex">
                ...
                <div class="base-info-item">
                    ...
                    <el-button type="text" @click="openModifyDialog('修改所属手机号码', 'depart')">修改</el-button>
                </div>
                <div class="base-info-item">
                    <div class="flex">
            ...
            <el-table class="table" :data="loginLog" height="342">
                <el-table-column label="登录账号" width="auto" prop="account"></el-table-column>
                <el-table-column label="登录方式" width="auto" prop="loginWay"></el-table-column>
                <el-table-column label="登录IP" width="auto" prop="ip"></el-table-column>
                <el-table-column label="创建时间" width="auto" prop="loginTime"></el-table-column>
            </el-table>
        </el-card>
        <!-- 更改手机号码和密码的弹窗 -->
        <el-dialog :title="title" :visible.sync="showDialog" width="30%" class="change" :close-on-click-modal="false">
            <div class="dialogContainer">
                ...
                <div class="inputPassword" v-if="changeType === false" key="password">
                    <el-form label-position="top" label-width="50px" :model="password" :rules="pwrules" size="small"
                        ref="passwordForm">
                        <el-form-item label="旧密码" prop="oldPassword">
                            <el-input v-model="password.oldPassword" show-password></el-input>
                        </el-form-item>
                        <el-form-item label="新密码" prop="newPassword" required>
                            <el-input v-model="password.newPassword" show-password placeholder="不低于8位的数字、字母组合">
                            </el-input>
                        </el-form-item>
                        <el-form-item label="再次输入新密码" prop="newPasswordTwice" required>
                            <el-input v-model="password.newPasswordTwice" show-password placeholder="不低于8位的数字、字母组合">
                            </el-input>
                        </el-form-item>
                    </el-form>
                </div>
                <div class="inputPhone" v-else key="phone">
                    <el-form label-position="top" label-width="50px" :model="phone" :rules="phrules" size="small"
                        ref="phoneForm">
                        ...
                        <el-form-item label="验证码" prop="oldSmsCode">
                            <el-input v-model="phone.oldSmsCode" style="width: 280px; margin-right: 15px"></el-input>
                            <el-button type="primary" @click="getOldSmsCode" :disabled="getOldCode" :plain="oldCode"
                                style="width: 100px">{{ oldCodeButton }}</el-button>
                        </el-form-item>
                        ...
                        <el-form-item label="验证码" prop="newSmsCode">
                            <el-input v-model="phone.newSmsCode" style="width: 280px; margin-right: 15px"></el-input>
                            <el-button type="primary" @click="getNewSmsCode" :disabled="getNewCode" :plain="newCode"
                                style="width: 100px">{{ newCodeButton }}</el-button>
                        </el-form-item>
                    </el-form>
                </div>
            </div>
        ...
        <!-- 操作结果 -->
        <el-dialog title="操作结果" :visible.sync="resultDialog" width="30%" class="resultDialog" :show-close="showClose">
            <div class="result">
        ...
        <!-- 修改个人信息 -->
        <el-dialog :title="operationType.label" :visible.sync="modifyDialog" width="30%" :show-close="true">
            <el-form :model="operationForm" :rules="operationRules">
                <el-form-item v-if="operationType.value == 'name'" prop="name">
                    <el-input v-model="operationForm.name" placeholder="请输入新的名字"></el-input>
                </el-form-item>
                <el-form-item v-else>
                    <el-select v-model="operationForm.currentValue" @change="
                ...
                <el-form-item>
                    <div class="dialog-btn">
                        ...
                        <el-button type="primary" :disabled="operationBtn"
                            @click="onSubmitOperation(operationType.value)">确定</el-button>
                    </div>
                </el-form-item>
            </el-form>
        </el-dialog>
        <!-- 更换头像dialog -->
        <el-dialog title="上传头像" :visible.sync="uploadDialog" width="50%" :show-close="true">
            <upload ref="upload" width="350" accept=".png,.jpg" :autoUpload="false" :fixedUploadBtn="false" :limit="1"
                @fileUrl="uploadAvatar"></upload>
            <div class="dialog-btn">
